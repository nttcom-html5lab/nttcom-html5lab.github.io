...
var flexvideo=function(){function t(t,e,n,o,r){util.isDebug&&console.log("flexvideo.initialize()");var a=$(document.createDocumentFragment());if(util.support.inlineVideo)m=$("<video>").attr({id:"video",autoplay:"autoplay",poster:n.replace("%{sec}","0")+"."+w}),g=m.get(0),$.each(x,function(){$("<source>").attr({src:e+"."+this,type:"video/"+this}).appendTo(m)}),a.append(m),util.support.transform&&m.css({width:M+"px",height:O+"px"}),m.on("loadedmetadata",$.proxy(function(){U=g.duration,this.emit("loadedmetadata")},this)).on("loadeddata",$.proxy(function(){this.emit("loadeddata")},this)).on("timeupdate",$.proxy(function(){this.emit("timeupdate")},this)).on("ended",$.proxy(function(){this.emit("ended")},this)).on("playing",$.proxy(function(){this.emit("playing")},this)).on("pause",$.proxy(function(){this.emit("paused")},this));else{v=$("<div>").attr("id","pictures");for(var s=0;o>=s;s+=r){var u=n.replace("%{sec}",s)+"."+w,l=$("<img>").attr({"data-sec":s,"data-src":u}).appendTo(v);s+r*J>s&&l.attr("src",u),F.push(s)}var l=$("<img>").attr({src:n.replace("%{sec}",0)+"."+w}).addClass("poster").appendTo(v);a.append(v),v.show(),U=o,setTimeout($.proxy(function(){this.emit("loadedmetadata"),setTimeout($.proxy(function(){this.emit("loadeddata")},this),0)},this),0)}h=$(t).append(a),util.support.inlineVideo||util.support.transform||h.find("img").css({width:"100%",height:"100%"}),y.on("resize iosstatusbarvisibilitychange",i),i()}function i(t){function i(t,i){switch(i){case"translate":var e=arguments[2],n=arguments[3];util.support.transform?t.transform=(t.transform?t.transform+" ":"")+"translate("+e+"px, "+n+"px)":(t.left=e+"px",t.top=n+"px");break;case"scale":var o=arguments[2];util.support.transform?t.transform=(t.transform?t.transform+" ":"")+"scale("+o+")":(t.width=M*o+"px",t.height=O*o+"px")}}if(t&&t.type&&console.log("window.on"+t.type),k)var e=window.innerWidth,n=window.innerHeight;else var e=y.width(),n=y.height();n-=T;var o={},r=0,a=0;e/n>M/O?(r=(n-e*O/M)/2,i(o,"translate",0,r+T),a=e/M,i(o,"scale",a)):(r=(e-n*M/O)/2,i(o,"translate",r,T),a=n/O,i(o,"scale",a)),h.css(o)}function e(t,i){return $(this).on(t,i),this}function n(t,i){return $(this).off(t,i),this}function o(t,i){return $(this).trigger(t,i),this}function r(){return util.isDebug&&console.log("flexvideo.play()"),util.support.inlineVideo?g.seeking?(util.isDebug&&console.log("waiting for playing"),R++<C?void setTimeout(r,z):void(util.isDebug&&console.log("waiting for playing time out"))):(R=0,void g.play()):(W=util.getNow(),G=setInterval($.proxy(c,this),q),void this.emit("playing"))}function a(){return util.isDebug&&console.log("flexvideo.pause()"),util.support.inlineVideo?void g.pause():(G&&(clearInterval(G),G=0),void this.emit("paused"))}function s(){return U}function u(t){function i(){for(var i=-1,e=F.length,n=0;e>n;n++)if(F[n]>t){i=n-1;break}return-1===i&&(i=e-1),i}function e(t,i,e,n){var o=v.find("img[data-sec="+F[t]+"]");i&&(o.attr("src")||o.attr("src",o.attr("data-src"))),e&&o.css("z-index","0").fadeIn("1000"),n&&(o.css("z-index","-100"),setTimeout(function(){o.hide()},1e3))}if(util.support.inlineVideo)return void(g.currentTime=t);var n=F.length,o=i();if(0===S||j!==o){e(j,!1,!1,!0),e(o,!0,!0,!1),B=Math.min(o+J,n);for(var r=o+1;B>r;r++)e(r,!0,!1,!1);util.isDebug&&console.log("change picture "+o),j=o}S=t,this.emit("timeupdate"),t>=U&&(clearInterval(G),G=0,this.emit("ended"))}function l(){return util.support.inlineVideo?g.currentTime:S}function d(){return util.support.inlineVideo?g.readyState:-1===U?V:E}function p(){return util.support.inlineVideo?g.ended:S>=U}function c(){var t=util.getNow(),i=Math.min(S+(t-W)/1e3,U);W=t,$.proxy(u,this)(i)}function f(){return util.support.inlineVideo?g.buffered:{length:1,start:function(){return F[j]},end:function(){return F[B]}}}var h,m,g,v,y=$(window),x=["webm","mp4"],w="jpg",T=50,V=0,A=1,b=2,D=3,E=4,H=1280,_=720,N=960,I=540,z=100,C=50,R=0,U=-1;if(util.os.iOS)var k=/^[^2-6]/.test(util.os.version);var M=util.support.inlineVideo?H:N,O=util.support.inlineVideo?_:I;if(!util.support.inlineVideo)var S=-1,F=[],G=0,j=0,B=0,W=util.getNow(),q=200,J=5;return util.support.inlineVideo||$(window).on("beforeunload",function(){G&&(clearInterval(G),G=0)}),{HAVE_NOTHING:V,HAVE_METADATA:A,HAVE_CURRENT_DATA:b,HAVE_FUTURE_DATA:D,HAVE_ENOUGH_DATA:E,initialize:t,on:e,off:n,emit:o,play:r,pause:a,getDuration:s,setCurrentTime:u,getCurrentTime:l,getReadyState:d,getEnded:p,getBuffered:f}}();
