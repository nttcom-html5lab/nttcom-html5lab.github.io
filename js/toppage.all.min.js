...
var flexvideo=function(){function t(t,e,n,o,r){util.isDebug&&console.log("flexvideo.initialize()");var a=$(document.createDocumentFragment());if(util.support.inlineVideo)g=$("<video>").attr({id:"video",autoplay:"autoplay",poster:n.replace("%{sec}","0")+"."+x}),m=g.get(0),$.each(w,function(){$("<source>").attr({src:e+"."+this,type:"video/"+this}).appendTo(g)}),a.append(g),util.support.transform&&g.css({width:O+"px",height:S+"px"}),g.on("loadedmetadata",$.proxy(function(){z=m.duration,this.emit("loadedmetadata")},this)).on("loadeddata",$.proxy(function(){this.emit("loadeddata")},this)).on("timeupdate",$.proxy(function(){this.emit("timeupdate")},this)).on("ended",$.proxy(function(){this.emit("ended")},this)).on("playing",$.proxy(function(){this.emit("playing")},this)).on("pause",$.proxy(function(){this.emit("paused")},this));else{v=$("<div>").attr("id","pictures");for(var s=0;o>=s;s+=r){var u=n.replace("%{sec}",s)+"."+x,l=$("<img>").attr({"data-sec":s,"data-src":u}).appendTo(v);0===s&&l.attr("src",u),G.push(s)}a.append(v),v.show(),z=o,setTimeout($.proxy(function(){this.emit("loadedmetadata"),setTimeout($.proxy(function(){this.emit("loadeddata")},this),0)},this),0)}h=$(t).append(a),util.support.inlineVideo||util.support.transform||h.find("img").css({width:"100%",height:"100%"}),y.on("resize iosstatusbarvisibilitychange",i),i()}function i(t){function i(t,i){switch(i){case"translate":var e=arguments[2],n=arguments[3];util.support.transform?t.transform=(t.transform?t.transform+" ":"")+"translate("+e+"px, "+n+"px)":(t.left=e+"px",t.top=n+"px");break;case"scale":var o=arguments[2];util.support.transform?t.transform=(t.transform?t.transform+" ":"")+"scale("+o+")":(t.width=O*o+"px",t.height=S*o+"px")}}if(t&&t.type&&console.log("window.on"+t.type),C)var e=window.innerWidth,n=window.innerHeight;else var e=y.width(),n=y.height();n-=V;var o={},r=0,a=0;e/n>O/S?(r=(n-e*S/O)/2,i(o,"translate",0,r+V),a=e/O,i(o,"scale",a)):(r=(e-n*O/S)/2,i(o,"translate",r,V),a=n/S,i(o,"scale",a)),h.css(o)}function e(t,i){return $(this).on(t,i),this}function n(t,i){return $(this).off(t,i),this}function o(t,i){return $(this).trigger(t,i),this}function r(){return util.isDebug&&console.log("flexvideo.play()"),util.support.inlineVideo?m.seeking?(util.isDebug&&console.log("waiting for playing"),k++<U?void setTimeout(r,R):void(util.isDebug&&console.log("waiting for playing time out"))):(k=0,void m.play()):(W=util.getNow(),M=setInterval($.proxy(c,this),q),void this.emit("playing"))}function a(){return util.isDebug&&console.log("flexvideo.pause()"),util.support.inlineVideo?void m.pause():(M&&(clearInterval(M),M=0),void this.emit("paused"))}function s(){return z}function u(t){function i(){for(var i=-1,e=G.length,n=0;e>n;n++)if(G[n]>t){i=n-1;break}return-1===i&&(i=e-1),i}function e(t,i,e,n){var o=v.find("img[data-sec="+G[t]+"]");i&&(o.attr("src")||o.attr("src",o.attr("data-src"))),e&&o.show(),n&&o.hide()}if(util.support.inlineVideo)return void(m.currentTime=t);var n=G.length,o=i();(0===F||j!==o)&&(e(j,!1,!1,!0),e(o,!0,!0,!1),n-1>o?(B=o+1,e(B,!0,!1,!1)):B=o,util.isDebug&&console.log("change picture "+o),j=o),F=t,this.emit("timeupdate"),t>=z&&(clearInterval(M),M=0,this.emit("ended"))}function l(){return util.support.inlineVideo?m.currentTime:F}function d(){return util.support.inlineVideo?m.readyState:-1===z?T:E}function p(){return util.support.inlineVideo?m.ended:F>=z}function c(){var t=util.getNow(),i=Math.min(F+(t-W)/1e3,z);W=t,$.proxy(u,this)(i)}function f(){return util.support.inlineVideo?m.buffered:{length:1,start:function(){return G[j]},end:function(){return G[B]}}}var h,g,m,v,y=$(window),w=["webm","mp4"],x="jpg",V=50,T=0,A=1,b=2,D=3,E=4,H=1280,_=720,N=960,I=540,R=100,U=50,k=0,z=-1;if(util.os.iOS)var C=/^[^2-6]/.test(util.os.version);var O=util.support.inlineVideo?H:N,S=util.support.inlineVideo?_:I;if(!util.support.inlineVideo)var F=-1,G=[],M=0,j=0,B=0,W=util.getNow(),q=200;return util.support.inlineVideo||$(window).on("beforeunload",function(){M&&(clearInterval(M),M=0)}),{HAVE_NOTHING:T,HAVE_METADATA:A,HAVE_CURRENT_DATA:b,HAVE_FUTURE_DATA:D,HAVE_ENOUGH_DATA:E,initialize:t,on:e,off:n,emit:o,play:r,pause:a,getDuration:s,setCurrentTime:u,getCurrentTime:l,getReadyState:d,getEnded:p,getBuffered:f}}();
